...
export function handleHealthCheckError(error, storageType, latencyStart) {
  ...
  throw new StorageError(
    `${storageType} health check failed`,
    storageType,
    'ping',
    null,
    {
 ...
 */
export async function handleTransactionError(error, client, storageType, stats = null, logger = null) {
...
export function handleMessageProcessingError(error, messageId, stage, logger = null) {
  ...
  throw new ProcessingError(
    `Message processing failed at ${stage}`,
    messageId,
    stage,
    null,
    { cause: error }
