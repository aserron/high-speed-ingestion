...
class APIServer:
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        self.metrics_collector = get_metrics_collector(self.config.monitoring)
...
_global_api_server: APIServer | None = None


def get_api_server(config: dict[str, Any] | None = None) -> APIServer:
