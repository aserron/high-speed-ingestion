...
def validate_config_cmd(env: Optional[str], json_output: bool, verbose: bool):
...
def _display_validation_results(is_valid: bool, errors: list, warnings: list, env: Optional[str], verbose: bool):
    ...
    if verbose:
        try:
            ...
            console.print(f"[yellow]⚠️  Could not load configuration details: {str(e)}[/yellow]")
