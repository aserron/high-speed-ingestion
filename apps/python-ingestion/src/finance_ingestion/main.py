...
class FinanceIngestionApp:
    ...
    async def _handle_component_error(self, component: str, error: Exception, recovery_action: callable | None = None):
...
_global_app: FinanceIngestionApp | None = None


def get_app(config: dict[str, Any] | None = None) -> FinanceIngestionApp:
